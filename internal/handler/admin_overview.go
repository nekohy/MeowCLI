			...
			CredentialFields: []credentialField{
				{
					...
					Label:       "Tokens",
					Kind:        "textarea",
					Placeholder: "一行一个 Refresh Token、Refresh Token@client_id 或 Access Token",
					HelpText:    "Codex RT 可写成 rt_token@client_id，刷新时会使用 @ 后的 client_id；不写则使用默认 Codex client_id",
					Preferred:   true,
				},
			},
