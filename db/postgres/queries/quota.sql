...
INSERT INTO quota (credential_id, quota_5h, quota_7d, reset_5h, reset_7d, synced_at)
...
INSERT INTO quota (credential_id, throttled_until, synced_at)
VALUES ($1, $2, NOW())
ON CONFLICT (credential_id) DO UPDATE
SET
...
-- name: GetQuota :one
SELECT * FROM quota WHERE credential_id = $1 LIMIT 1;
...
DELETE FROM quota WHERE credential_id = $1;
