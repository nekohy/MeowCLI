...
ALTER TABLE models ADD COLUMN IF NOT EXISTS fill_first BOOLEAN NOT NULL DEFAULT FALSE;
...
CREATE TABLE IF NOT EXISTS codex_quota (
    ...
    quota_spark_1mo FLOAT NOT NULL DEFAULT 1.0,
    reset_5h TIMESTAMPTZ,
    reset_7d TIMESTAMPTZ,
    reset_1mo TIMESTAMPTZ,
    reset_spark_5h TIMESTAMPTZ,
    reset_spark_7d TIMESTAMPTZ,
    reset_spark_1mo TIMESTAMPTZ,
