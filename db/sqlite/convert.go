...
func reverseInfoTo(origin string, handler string, planTypes string, plugin string, contentAffinity bool, fillFirst bool, extra string) db.ReverseInfoFromModelRow {
...
func modelRowTo(alias, origin, handler, planTypes, plugin string, contentAffinity bool, fillFirst bool, extra string) db.ModelRow {
	return db.ModelRow{
		Alias:     alias,
		Origin:    origin,
		Handler:   handler,
...
func listAvailableCodexRowTo(id, planType string, quota5h, quota7d, quota1mo, quotaSpark5h, quotaSpark7d, quotaSpark1mo float64, reset5h, reset7d, reset1mo, resetSpark5h, resetSpark7d, resetSpark1mo, throttledUntil, throttledUntilSpark, syncedAt string) db.ListAvailableCodexRow {
...
func listGeminiCLIRowTo(id, status, accessToken, refreshToken, expired, email, projectID, planType, reason string, quotaPro, quotaFlash, quotaFlashlite float64, resetPro, resetFlash, resetFlashlite, throttledUntilPro, throttledUntilFlash, throttledUntilFlashlite, syncedAt string) db.ListGeminiCLIRow {
	return db.ListGeminiCLIRow{
		...
		ThrottledUntilPro:       parseTime(throttledUntilPro),
		ThrottledUntilFlash:     parseTime(throttledUntilFlash),
		ThrottledUntilFlashlite: parseTime(throttledUntilFlashlite),
		SyncedAt:                parseTime(syncedAt),
	}
}
